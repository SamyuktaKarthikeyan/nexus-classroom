...
const Footer = () => {
  return (
    <div>
        <footer className="text-gray-300 body-font bottom-0 bg-slate-950">
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
  <a className="flex title-font font-medium items-center text-gray-50 mb-1 md:mb-1">
  <a className="hidden" href="https://www.vecteezy.com/free-vector/question">Question Vectors by Vecteezy</a>
