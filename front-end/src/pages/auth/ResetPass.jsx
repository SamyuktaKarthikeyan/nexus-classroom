const ResetPass = () => {
  ...
  <div className="relative overflow-hidden h-[150px] w-full md:flex md:w-1/2 md:h-full bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center ">
    <img src="/imgs/signin-pat.jpeg" className="w-full"/>
  </div>
  
  <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
    <form className="bg-white">
      <h1 className="text-gray-800 font-bold text-2xl mb-7">Reset your Password</h1>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-600" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
        ...
        <input className="pl-2 outline-none border-none  text-gray-600" type="text" name="" id="" placeholder="Re-enter Password" />
      </div>
      <button type="submit" className="block w-full bg-blue-800 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Reset Password</button>
    </form>
  </div>
  </div>
  </div>
