...
<a  href="https://icons8.com/icon/Alsmzv0mFxxJ/menu" className="hidden">Menu</a> <a href="https://icons8.com" className="hidden">Icons8</a>
      <div className="flex justify-center">
        <button className="ml-2 inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" onClick={() => navigate('/nexus/login')}>Log In</button>
        <button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg"onClick={() => navigate('/nexus/signup')}>Sign Up</button>
      </div>
    </div>
